# # navigation_verb_flow_check/core/nav_flow.py
...
#     """
#     문서에서 월 라벨과 키 집합을 추출한다.
#     - 월: statement.timestamp(없으면 stored)에서 YYYY-MM
#     - 키: context.extensions / result.extensions 의 dict 키
#     """
...
#     return month, keys
# navigation_verb_flow_check/core/assessment_flow.py
from __future__ import annotations
