# media_verb_flow_check/main.py
import os, sys
from pathlib import Path
ROOT = Path(__file__).resolve().parent
if str(ROOT) not in sys.path:
    sys.path.insert(0, str(ROOT))
from media_verb_flow_check.cli import main as cli_main
...
def build_default_args():
    return [
        ...
        "--profile-id", os.getenv("AVFC_PROFILE","http://lecognizer.com/xapi/profiles/media"),
        "--fetch-mode", "month",
