# assessment_verb_flow_check/io/source_iter.py
import json
import time
import logging
...
DEFAULT_ASSESSMENT_PROFILE_ID = "http://lecognizer.com/xapi/profiles/assessment"
...
def iter_mongo_verb(
    ...
    profile_id: Optional[str] = DEFAULT_ASSESSMENT_PROFILE_ID,  # ✅ Assessment 기본
) -> Iterator[dict]:
...
def iter_mongo_verb_monthwise(
    ...
    batch_size: int = 2000,
    verb_id: str = "",
    profile_id: Optional[str] = DEFAULT_ASSESSMENT_PROFILE_ID,  # ✅ 통일
