# assessment_verb_flow_check/core/logging_setup.py
import logging
...
def setup_logging(
    ...
    - 파일명은 verb 별로 분리: assessment_verb_flow_check_<verb>.log
    """
    log_root = Path(log_dir)
    log_root.mkdir(parents=True, exist_ok=True)

    fname = f"assessment_verb_flow_check_{_verb_name(verb_id)}.log"
